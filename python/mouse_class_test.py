...
VP = np.load('./data/mvfb_class_varpar4.npz')
...
#in_spikes[1] = list(range(20,30)) #This is the 3rd channel firing
#in_spikes[1] = [] # This is nothing firing
in_spikes[1] = list(range(0,20)) # This is both firing
inlist[0] = inlist[1]

# Since we are not using the noise channel, I'm getting rid of it in our graphics. 
inlist[2] = inlist.pop(3)
...
plt.title("Output")
plt.savefig("temp_new.png")
plt.close()

#TODO: Larger mb_size on this problem?
snn.mb_size = mb_size
mean_costs = np.zeros(epochs // mb_size)
plot_allinone(snn, ret, inlist, mean_costs, path = "aio_new.png")
snn.mb_size = 1
